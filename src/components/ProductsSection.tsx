              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    ...
                    className="inline-flex items-center gap-2.5 rounded-xl bg-foreground px-5 py-3 text-sm font-semibold text-black transition-transform hover:-translate-y-0.5"
                  >
